defmodule SymphonyElixir.StatusDashboard do
  ...
  defp format_project_link_lines do
    project_part =
      case github_project_url(Config.settings!().tracker) do
  ...
  defp github_project_url(%{owner_type: "organization", owner_login: owner_login, project_number: project_number})
       when is_binary(owner_login) and owner_login != "" and is_integer(project_number) do
    "https://github.com/orgs/#{owner_login}/projects/#{project_number}"
  end

  defp github_project_url(%{owner_type: "user", owner_login: owner_login, project_number: project_number})
       when is_binary(owner_login) and owner_login != "" and is_integer(project_number) do
    "https://github.com/users/#{owner_login}/projects/#{project_number}"
  end
